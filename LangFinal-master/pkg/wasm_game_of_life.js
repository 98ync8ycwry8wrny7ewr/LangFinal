...
export class GameBoard {
    ...
    * @returns {GameBoard}
    */
    static new(x, y, start_state) {
        try {
            var ret = wasm.gameboard_new(x, y, addBorrowedObject(start_state));
    ...
    */
    width() {
        var ret = wasm.gameboard_width(this.ptr);
        return ret >>> 0;
    }
    /**
    * @returns {number}
    */
    height() {
        var ret = wasm.gameboard_height(this.ptr);
        return ret >>> 0;
    }
    /**
    * @returns {number}
    */
    cells() {
        var ret = wasm.gameboard_cells(this.ptr);
        return ret;
    }
}
...
export const __wbg_keys_a0639c6cc7ebeba9 = function(arg0) {
